...
const About: React.FC = () => (
  <section
    id="about"
    className="relative py-24 bg-white text-neutral-800 px-6 sm:px-12 md:px-20 lg:px-32"
  >
    <div className="relative max-w-3xl mx-auto text-center">
      ...
      <h2 className="text-4xl sm:text-5xl font-display font-bold mb-6 leading-tight tracking-tight text-neutral-900">
      ...
      {/* Body text */}
      <p className="text-base sm:text-lg leading-relaxed text-neutral-600 whitespace-pre-line">
...
ผมพร้อมให้คำปรึกษาและดูแลให้ธุรกิจของคุณมีเว็บไซต์ที่ตอบโจทย์อย่างแท้จริง`}
      ...
      <div className="mt-10 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
        ...
        <a
          href="#services"
          className="inline-flex justify-center items-center gap-2 px-8 py-3 min-w-[160px] 
                     text-accent border border-accent/30 bg-white hover:bg-accent/10 font-semibold text-base 

  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-5 text-white/90 text-base sm:text-lg md:text-xl max-w-2xl mx-auto font-light">
          ฟรีแลนซ์เดฟบ้าน ๆ ฝีมือไม่ธรรมดา ราคาจับต้องได้ เข้าถึงง่าย ใช้งานจริงได้แน่นอน
        </p>
